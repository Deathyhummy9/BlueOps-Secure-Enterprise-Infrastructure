...
-Name BlueOps-DC-Server, OsType:Windows Server 2022 CPU:2, RAM: 4gb disk:50GB ip 192.168.10.10




##.pfSense Console Setup
  After booting pfSense:
    Just run through the basic set up and make the ip for lan 192.168.5.1
